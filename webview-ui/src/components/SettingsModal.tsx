  ...
  return (
    <>
      ...
      >
        ...
        <button
          onClick={() => {
            bridge.postMessage({ type: 'openSessionsFolder' })
            onClose()
          }}
        ...
        <button
          onClick={() => {
            bridge.postMessage({ type: 'exportLayout' })
            onClose()
          }}
        ...
        <button
          onClick={() => {
            bridge.postMessage({ type: 'importLayout' })
            onClose()
          }}
        ...
        <button
          onClick={() => {
            ...
            bridge.postMessage({ type: 'setSoundEnabled', enabled: newVal })
          }}
